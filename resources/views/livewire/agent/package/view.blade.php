                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm font-medium text-dark/70">
                            Selected: <span
                                class="font-bold text-dark">{{ $packages->firstWhere('id', $selectedPackageId)->name ?? 'Package' }}</span>
                        </span>
                    </div>
                ...
                <div class="space-y-6">
                            ...
                            @if ($paymentProof)
                                <div
                                    ...
                                    <p class="mt-2 text-xs font-medium text-center text-dark/40">
                                        Selected: {{ $paymentProof->getClientOriginalName() }}
                                    </p>
                                </div>
                            @endif

                            <!-- 3. Uploading Progress Overlay -->
                    ...
                    <div class="flex gap-4 pt-4">
                        <button wire:click="submitPayment" wire:loading.attr="disabled"
                            ...
                            <!-- Normal State: Hidden when submitPayment is loading -->
                            <span wire:loading.remove wire:target="submitPayment">
                                Submit Payment Proof
                            </span>

                            <!-- Loading State: Visible only when submitPayment is loading -->
                            <span wire:loading wire:target="submitPayment" class="flex items-center gap-2">
