<div>
    ...
    <div class="space-y-8">
        <!-- Header Section -->
        <x-header-section headerwprimary="Daily Reward" headerwsecondary="List"
                        ...
                        <tr class="transition-all hover:bg-primary/[0.03] group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.daily.reward.form', ['id' => $reward->id]) }}"
                                        wire:navigate
    ...
    <div wire:ignore>
        <x-delete-modal id="deleteModal" title="Delete Daily Reward"
            message="Are you sure you want to delete this reward?" confirmAction="delete"
