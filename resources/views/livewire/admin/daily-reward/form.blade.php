<div>
    <div class="space-y-8">
        <x-header-section :headerwprimary="$isEdit ? 'Edit' : 'Create'" headerwsecondary="Daily Reward"
            tagline="Set the coins payout values for your daily reward system." />
    </div>
        ...
        <div class="space-y-6 lg:col-span-2">
            <div class="p-8 border shadow-sm bg-surface rounded-3xl border-primary/10">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-xl font-bold text-dark">Daily Reward Value Details</h2>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <!-- Task Field -->
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-dark/70">Days</label>
                    ...
                    <!-- coins Field - FIXED wire:model from "coinss" to "coins" -->
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-dark/70">coins Payout</label>
