<div>
    ...
    <div class="space-y-8">
        <!-- Header Section -->
        <x-header-section headerwprimary="Reward" headerwsecondary="List"
            tagline="Review and manage your reward efficiently." />
    </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr
                        ...
                        <th class="px-6 py-4 font-semibold">Mission</th>
                        <th class="px-6 py-4 font-semibold">Task</th>
                        <th class="px-6 py-4 font-semibold">Coin</th>
                    ...
                    @forelse ($rewards as $reward)
                        <tr class="transition-all hover:bg-primary/[0.03] group">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $reward->is_active ? 'text-indigo-700 bg-indigo-100/50 border border-indigo-200' : 'text-red-700 bg-red-100/50 border border-red-200' }}">
                                    {{ $reward->is_active ? 'Active' : 'In-active' }}
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.reward.edit', ['id' => $reward->id]) }}" wire:navigate
                                    ...
                                    <!-- Table row loop -->
                                    <button onclick="openDeleteModal({{ $reward->id }})"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <h3 class="text-lg font-bold text-dark">No Reward Found</h3>
    ...
    <div wire:ignore>
        <x-delete-modal id="deleteModal" title="Delete Reward" message="Are you sure you want to delete this reward?"
    ...
    <script>
        function openDeleteModal(coinId) {
            ...
            @this.set('rewardIdToDelete', coinId);
        ...
        function closeDeleteModal() {
            ...
            @this.set('rewardIdToDelete', null);
        }
