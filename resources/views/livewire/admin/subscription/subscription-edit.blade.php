<div class="space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div class="space-y-8">
            <!-- Header Section -->
            <x-header-section headerwprimary="Edit" headerwsecondary="Subscription"
    ...
    <form wire:submit.prevent="saveSubscription" class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" wire:model="price"
                                class="w-full py-3 pl-10 pr-4 transition-all border outline-none bg-background border-primary/10 rounded-xl text-dark focus:border-primary focus:ring-1 focus:ring-primary"
                                placeholder="0.00">
                        </div>
                        @error('price')
                            <span class="block text-xs text-red-600">{{ $message }}</span>
        ...
        <div class="space-y-6">
            <div class="sticky top-24">
                <!-- Status Card -->
                <div class="p-8 mb-4 border shadow-sm bg-surface rounded-3xl border-primary/10">
