...
>
    ...
    <nav class="flex-1 px-4 space-y-2 overflow-y-auto">
        ...
        @auth('admin')
            ...
            <!-- ================= AGENTS ================= -->
            <!-- FIXED: Use array to prevent overlap with agent.subscriptions -->
            <div
                x-data="{ open: @js(request()->routeIs(['admin.agent.create', 'admin.agent.list'])) }"
                class="relative"
            >
                <button
                    type="button"
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.agent.create') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.agent.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Create Agent
                    </a>
                    <a href="{{ route('admin.agent.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.agent.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Agent List
                    </a>
                </div>
            </div>
            ...
            <!-- ================= USERS ================= -->
            <div
                x-data="{ open: @js(request()->routeIs('admin.user.*')) }"
                class="relative"
            >
                <button
                    type="button"
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.user.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.user.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        User List
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.coin.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.coin.create') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.coin.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Create Coin
                    </a>
                    <a href="{{ route('admin.coin.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.coin.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Coin List
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.reward.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.reward.create') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.reward.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Create Reward
                    </a>
                    <a href="{{ route('admin.reward.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.reward.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Reward List
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.gift.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.gift.create') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.gift.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Create Gift
                    </a>
                    <a href="{{ route('admin.gift.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.gift.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Gift List
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.subscriptions.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.subscriptions.create') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.subscriptions.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                    ...
                    <a href="{{ route('admin.subscriptions.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.subscriptions.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Subscriptions List
                    </a>
                </div>
            </div>
            ...
            <!-- ================= AGENT SUBSCRIPTIONS ================= -->
            <div x-data="{ open: @js(request()->routeIs('admin.agent.subscriptions.*')) }" class="relative">
                <button type="button" @click="open = !open"
                    class="w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all group
                    {{ request()->routeIs('admin.agent.subscriptions.*') ? 'bg-primary text-white shadow-md shadow-primary/20' : 'text-dark/70 hover:bg-gray-100 hover:text-primary' }}">
                    <div class="flex items-center gap-3">
                        <x-heroicon-s-ellipsis-horizontal-circle class="w-5 h-5" />
                        <span class="font-medium">Agent Subscriptions</span>
                    </div>
                    <div :class="open ? 'rotate-180' : ''" class="transition-transform duration-200">
                        <x-heroicon-s-chevron-down class="w-4 h-4" />
                    </div>
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.agent.subscriptions.create') }}" wire:navigate
                        class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm transition-all
                        {{ request()->routeIs('admin.agent.subscriptions.create') ? 'text-primary font-bold bg-primary/10' : 'text-dark/60 hover:text-primary hover:bg-gray-100' }}">
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.agent.subscriptions.create') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Create Agent Subscriptions
                    </a>
                    <a href="{{ route('admin.agent.subscriptions.list') }}" wire:navigate
                        class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm transition-all
                        {{ request()->routeIs('admin.agent.subscriptions.list') ? 'text-primary font-bold bg-primary/10' : 'text-dark/60 hover:text-primary hover:bg-gray-100' }}">
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.agent.subscriptions.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.ticket.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.ticket.list') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.ticket.list') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Ticket List
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ open: @js(request()->routeIs('admin.setting.*')) }" class="relative">
                ...
                <div x-show="open" x-cloak x-transition class="pl-4 mt-2 space-y-1">
                    <a href="{{ route('admin.setting.general') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.setting.general') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        General Settings
                    </a>
                    <a href="{{ route('admin.setting.privacy-policy') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.setting.privacy-policy') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Privacy Policy
                    </a>
                    <a href="{{ route('admin.setting.term-condition') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.setting.term-condition') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        Terms & Conditions
                    </a>
                    <a href="{{ route('admin.setting.about-application') }}" wire:navigate
                        ...
                        <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin.setting.about-application') ? 'bg-primary' : 'bg-gray-300' }}"></span>
                        About Application
                    </a>
                </div>
            </div>
