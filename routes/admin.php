...
use App\Livewire\Admin\DailyReward\DRlist as DailyRewardList;
use App\Livewire\Admin\DailyReward\Form as DailyRewardForm;
...
Route::middleware(['admin', 'redirectifauth'])->group(function () {
    ...
    // daily reward
    Route::prefix('daily/reward')
        ->name('daily.reward.')
        ->group(function () {
            Route::get('/list', DailyRewardList::class)->name('list');
            Route::get('/form/{id?}', DailyRewardForm::class)->name('form');
        });
    ...
    Route::prefix('agent/purchase/packages')
        ->name('agent.purchase.packages.')
        ->group(function () {
            Route::get('/detail', AgentPackageList::class)->name('detail');
